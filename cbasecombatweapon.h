...
public:
	...
	float GetSpread()// "Default.ClipEmpty_Pistol" -> xref of the func is where spread gets calculated
	{
		...
		GetSpreadFn GetSpread = ( GetSpreadFn )( ( *( PDWORD* )this )[ 453 ] );
	...
	float GetInaccuracy()
	{
		...
		GetInaccuracyFn GetCone = ( GetInaccuracyFn )( ( *( PDWORD* )this )[ 483 ] );
		return GetCone( this );
	}
	...
	void UpdateAccuracyPenalty()
	{
		...
		UpdateAccuracyPenaltyFn AccuracyPenalty = ( UpdateAccuracyPenaltyFn )( ( *( PDWORD* )this )[ 484 ] );
	...
	CWeaponData* GetWeaponData( void )
	{
		...
		return getvfunc< GetWeaponData_t >(this, 461)(this);
	}
