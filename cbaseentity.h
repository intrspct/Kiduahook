...
public:
	bool IsPlayer()
	{
		...
		return getvfunc< oIsPlayer >(this, 156)(this);
	}
...
/*	Vector& GetAbsOrigin()
	...
	{
		return ( *reinterpret_cast< CUtlVector<CAnimationLayer>* >( reinterpret_cast< std::uintptr_t >( this ) + 0x2990 ) );
	}
	...
	CAnimationLayer GetAnimationLayers( int iIndex )
	{
		// to find offset: use 9/12/17 dll
		// sig: 55 8B EC 51 53 8B 5D 08 33 C0
		return ( *( CAnimationLayer** ) ( ( DWORD )this + 0x2990) )[ iIndex ];
	}
	...
	void UpdateAnimation()
	{
		...
		getvfunc<UpdateClientSideAnimationFn>( this, 224 )( this );
	}
...
/*	void BuildTransformations( void* pStudioHdr, Vector *pos, Quaternion* q, matrix3x4_t& cameraTransform, int boneMask, byte *computed )
	...
	void InvalidateBoneCache()
	{
		...
		*(unsigned int*)((DWORD)this + 0x2928) = 0xFF7FFFFF; // m_flLastBoneSetupTime = -FLT_MAX; //note: m_flLastBoneSetupTime = 0x2928
...
/*	int GetIndex()
	...
	{
		Vector rtn{ };
		getvfunc<void( __thiscall* )( void*, Vector& )>( this, 285 )( this, rtn );
		return rtn;
